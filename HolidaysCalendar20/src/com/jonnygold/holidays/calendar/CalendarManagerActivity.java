...
import com.jonnygold.holidays.calendar.holiday.Calendar;
...
import com.jonnygold.holidays.calendar.web.UpdateService;
import com.jonnygold.holidays.calendar.web.UpdateService.UpdateState;
	...
	public class OnCalendarClickListener implements OnChildClickListener{		
		...
		public boolean onChildClick(ExpandableListView parent, View v,
			...
			case INSTALLED :
				...
				break;
			case NOT_INSTALLED :
				dialogBuilder.setTitle("Загрузить календарь?")
